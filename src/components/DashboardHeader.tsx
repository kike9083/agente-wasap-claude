          ...
          <div className="flex items-center gap-1.5">
            ...
            {permissions.canViewAppointments && (
              <button
                ...
                className="p-2 md:px-4 md:py-2 rounded-xl bg-teal-50 text-teal-700 text-xs md:text-sm font-semibold hover:bg-teal-100 ring-1 ring-teal-100 transition-all"
              >
