...
- **Fix doble respuesta:** Se corrigió un bug en `handler.ts` donde el primer contacto de un cliente enviaba el mensaje de bienvenida y, en el mismo ciclo, llamaba al LLM provocando dos saludos consecutivos.
